...
const ExamenExtraOral = ({ onSubmit, initialData}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm">
      <div className="space-y-6">
        <h3 className="text-2xl font-semibold text-gray-800 mb-4">Examen Extraoral</h3>
            ...
            <div className="ml-4 space-y-4 mt-4">
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  onChange={(e) => handleChange("otro_tipo", e.target.value)}
