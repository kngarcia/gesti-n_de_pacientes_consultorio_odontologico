  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md transition-all duration-300">
        ...
        {error && (
          <p className="text-red-500 text-sm text-center mt-2 animate-fadeIn">{error}</p>
        )}
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <button
            type="submit"
            className="w-full mt-6 bg-black hover:bg-gray-700 text-white font-bold py-3 rounded-xl transition-all duration-200 flex items-center justify-center"
            disabled={loading}
          >
            {loading ? (
