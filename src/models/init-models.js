...
function initModels(sequelize) {
  ...
  IntraOral.hasMany(Mucosas, { as: "Mucosas", foreignKey: "id_intra_oral"});
  TejidosDuros.belongsTo(IntraOral, { as: "Id_intra_oral_IntraOral", foreignKey: "Id_intra_oral"});
  IntraOral.hasMany(TejidosDuros, { as: "TejidosDuros", foreignKey: "Id_intra_oral"});
  Textura.belongsTo(IntraOral, { as: "id_intra_oral_IntraOral", foreignKey: "id_intra_oral"});
  IntraOral.hasMany(Textura, { as: "Texturas", foreignKey: "id_intra_oral"});
  ...
  Antecedentes.hasMany(AntecedentesEstomatologicos, { as: "AntecedentesEstomatologicos", foreignKey: "id_antecedente"});
  AntecedentesFamiliares.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesFamiliares, { as: "AntecedentesFamiliares", foreignKey: "id_antecedente"});
  AntecedentesGinecoobtetricos.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesGinecoobtetricos, { as: "AntecedentesGinecoobtetricos", foreignKey: "id_antecedente"});
  AntecedentesHospitalarios.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesHospitalarios, { as: "AntecedentesHospitalarios", foreignKey: "id_antecedente"});
  AntecedentesOdontologicos.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesOdontologicos, { as: "AntecedentesOdontologicos", foreignKey: "id_antecedente"});
  AntecedentesPatologicos.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesPatologicos, { as: "AntecedentesPatologicos", foreignKey: "id_antecedente"});
  AntecedentesToxixologicos.belongsTo(Antecedentes, { as: "id_antecedente_Antecedente", foreignKey: "id_antecedente"});
  Antecedentes.hasMany(AntecedentesToxixologicos, { as: "AntecedentesToxixologicos", foreignKey: "id_antecedente"});
  EstadoDientes.belongsTo(ExamenClinico, { as: "id_examen_clinico_ExamenClinico", foreignKey: "id_examen_clinico"});
  ExamenClinico.hasMany(EstadoDientes, { as: "EstadoDientes", foreignKey: "id_examen_clinico"});
  ExtraOral.belongsTo(ExamenClinico, { as: "id_examen_clinico_ExamenClinico", foreignKey: "id_examen_clinico"});
  ExamenClinico.hasMany(ExtraOral, { as: "ExtraOrals", foreignKey: "id_examen_clinico"});
  IntraOral.belongsTo(ExamenClinico, { as: "id_examen_clinico_ExamenClinico", foreignKey: "id_examen_clinico"});
  ExamenClinico.hasMany(IntraOral, { as: "IntraOrals", foreignKey: "id_examen_clinico"});
  ...
  Paladar.belongsTo(ExamenEstomatologico, { as: "ExamenEstomatologico_id_examen_estoma_ExamenEstomatologico", foreignKey: "ExamenEstomatologico_id_examen_estoma"});
  ExamenEstomatologico.hasMany(Paladar, { as: "Paladars", foreignKey: "ExamenEstomatologico_id_examen_estoma"});
  ...
  HistoriaClinica.hasMany(FrecuenciaCepillado, { as: "FrecuenciaCepillados", foreignKey: "id_historia"});
